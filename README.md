...
The face_engine service performs face detection and face embedding. It
listens at http://127.0.0.1:5010.
The person_creation backend runs the processing workflow and API. It
listens at http://127.0.0.1:5009.
The React/Vite frontend provides the local user interface. It listens at
http://localhost:5175.
...
Use a fresh output directory for every run, for example:
